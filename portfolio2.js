document.addEventListener("DOMContentLoaded", function () {
    ...
    const tools = [
        ...
        { title: "PostgreSQL", description: "Proficient in design, dvelopment, querying and managing large datasets." },
    ...
    function renderCards(dataArray, containerId) {
        ...
        dataArray.forEach(item => {
            ...
            if (item.description) {
                // For Work Experience, render description as bullet points
                if (containerId === "experience-cards" && Array.isArray(item.description)) {
                    ...
                    // For other categories, render description as a justified paragraph
